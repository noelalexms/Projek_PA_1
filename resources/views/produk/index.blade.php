            ...
            <div class="col ">
              <div class="card shadow-sm ">
                <div class="wrapper">
                  <div class="gallery">
                    <div class="image">
                       <span><img src="{{ url('image') }}/{{ $jenis_ulos->gambar }}"class="bd-placeholder-img img-produk"  ></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">                  
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group"> 
                      <button type="button" class="btn btn-sm btn-outline-primary"  data-bs-toggle="modal" data-bs-target="#produk0">More</button>
